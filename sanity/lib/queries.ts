...
export const STARTUP_ID_QUERY = defineQuery(`*[_type == "startup" && _id == $id] [0]{
  ...
  export const AUTHOR_BY_SANITY_ID_QUERY = defineQuery(`*[_type == "author" && _id == $id] [0]{
    _id,
    id,
    name,
    username,
  ...
  export const STARTUPS_BY_AUTHOR_ID_QUERY = defineQuery(`*[_type == "startup" && author._ref == $id] | order(_createdAt desc){
    _id,
    title,
    slug, 
    _createdAt, 
